...
/**
 * A {@link SessionSaveHandlerDatabaseOptionsFactory} class.
 *
 * @package Xloit\Bridge\Zend\Session\Service
 */
class SessionSaveHandlerDatabaseOptionsFactory extends AbstractFactory
{
    /**
    ...
    {
        return new DatabaseOptions($this->getOptions(true));
    }
}
