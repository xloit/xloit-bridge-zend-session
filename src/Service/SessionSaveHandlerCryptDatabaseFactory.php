...
use Xloit\Bridge\Zend\Session\SaveHandler\Database\CryptDatabase;

/**
 * A {@link SessionSaveHandlerCryptDatabaseFactory} class.
 *
 * @package Xloit\Bridge\Zend\Session\Service
 */
class SessionSaveHandlerCryptDatabaseFactory extends AbstractFactory
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $name, array $options = null)
    {
        ...
        return new CryptDatabase($adapter, $options);
    }
}
