...
use Xloit\Bridge\Zend\Session\SessionManagerAwareInterface;
use Zend\Session\ManagerInterface as SessionManagerInterface;

/**
 * A {@link SessionManagerAwareInitializer} class.
 *
 * @package Xloit\Bridge\Zend\Session\Service
 */
class SessionManagerAwareInitializer extends AbstractServiceInitializer
{
    /**
     *
     *
    ...
    {
        return SessionManagerAwareInterface::class;
    }
    ...
    {
        return [
            'getter' => 'getSessionManager',
            'setter' => 'setSessionManager'
        ];
    }
}
